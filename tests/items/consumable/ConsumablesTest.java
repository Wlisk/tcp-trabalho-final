...
public class ConsumablesTest {
    ...
    public void getConsumableTest() {
        ...
        assertTrue(cons.getConsumableType() == ConsumableType.FOOD);
        cons = Consumables.getConsumablePotion(0);
        assertTrue(cons.getConsumableType() == ConsumableType.POTION);
    }
    ...
    public void getRandomConsumableTest() {
        for(int i = 0; i < 100; i++){
            ...
            assertTrue(cons.getConsumableType() == ConsumableType.FOOD || cons.getConsumableType() == ConsumableType.POTION);
        }
