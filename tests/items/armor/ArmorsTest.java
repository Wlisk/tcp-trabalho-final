...
public class ArmorsTest {
    ...
    public void getRandomByClassTest() throws UnknownTypeException {
        for (int i = 0; i < 100; i++){
            ...
            assertEquals(armorMage.getArmorType(), ArmorType.ROBE);
            assertEquals(armorWarrior.getArmorType(), ArmorType.PLATE);
            assertEquals(armorArcher.getArmorType(), ArmorType.LEATHER);
        }
